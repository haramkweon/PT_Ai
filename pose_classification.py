...
Original file is located at
    https://colab.research.google.com/drive/1HgD3l6lDI6PBmBDYBqWnH6Fy0wlurqIW
...
#zf = zipfile.ZipFile(io.BytesIO(uploaded['E:\\AI DATA\\fitness_poses_images_in.zip']), "r")
# path = 'E:\\AI DATA\\fitness_poses_images_in.zip'
# with open(path, 'rb') as f:
#   data = f.read()
#zf = zipfile.ZipFile('C:\\fitness_pose_images_in.zip')
#zf.extractall()
#os.listdir('.')
...
with tqdm.tqdm(total=video_n_frames, position=0, leave=True) as pbar:
  for i in range(3):
    ...
    success, input_frame = v_cap.read()
